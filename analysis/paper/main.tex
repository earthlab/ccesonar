...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{../figures/map_plot.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.9\textwidth]{../figures/baseline-model-split.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{../figures/test-plot.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{../figures/test-scatter.pdf}
